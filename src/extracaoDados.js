...
// Função para localizar a sequência "Energia ElétricakWh" e retornar o primeiro e terceiro valor da linha
...
// Chamada das funções para conectar-se ao banco de dados e processar os PDFs
async function main() {
  await conectarBanco();
